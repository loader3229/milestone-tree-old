...
layers.m.milestones[42-1].effectDescription=function(){
	return "第六个里程碑的基础效果变为原来的(1+元里程碑数量)次方。";
}
...
layers.m.milestones[47-1].effectDescription=function(){
	return "第27个里程碑的基础效果变为原来的(1+元里程碑数量的0.25次方)次方。";
}
...
layers.m.milestones[52-1].effectDescription=function(){
	return "第六个里程碑的基础效果变为原来的(1+元里程碑数量的0.1次方)次方。";
}
...
layers.m.milestones[62-1].effectDescription=function(){
	return "第六个里程碑的基础效果变为原来的(元里程碑数量的0.129次方)次方。";
}
...
layers.m.milestones[67-1].effectDescription=function(){
	return "第27个里程碑的基础效果变为原来的(元里程碑数量的0.147次方)次方。";
}
...
layers.m.milestones[72-1].effectDescription=function(){
	return "第六个里程碑的基础效果变为原来的(元里程碑数量的0.1次方)次方。";
}
...
layers.mm.milestones[5-1].effectDescription=layers.mm.milestones[10-1].effectDescription=layers.mm.milestones[15-1].effectDescription=function(){
...
layers.mm.milestones[11-1].effectDescription=layers.mm.milestones[12-1].effectDescription=function(){
	return "第27个里程碑的效果变为原来的1.2次方。";
}
...
layers.hp.upgrades[24].description="第三级声望升级23的效果变得更好。";
